...
class Card8EffectTest {
    ...
    public void testDoEffect() {
        ...
        //creation of Card8Effect
        CharacterState c8 = new CharacterState(8, 2);
        Card8Effect card8Effect = new Card8Effect(gameController, c8);
        List<CharacterEffect> characterEffects = new ArrayList<>();
        characterEffects.add(card8Effect);
        ...
        gameController.getGame().setActiveEffect(c8);
        card8Effect.doEffect();
